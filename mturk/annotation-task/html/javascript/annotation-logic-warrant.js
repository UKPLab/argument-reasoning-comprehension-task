...
function validateSingleAnnotatedArgument(reasonId) {
    ...
    var warrantImpossible = $("input[name=" + reasonId + "_opposingStance_warrant_impossible]").is(":checked");
    ...
    var filledText = $("input[name=" + reasonId + "_opposingStance_warrant]").val().length > 0;
    // console.log("Filled text: " + filledText);

    // check whether the some groups have unfilled buttons
    var familiarSelected = $("input[name=" + reasonId + "_familiarGroup]:checked").val() != null;
    // console.log("Familiar selected: " + familiarSelected);

    var result = ((warrantImpossible && warrantImpossibleWhy) || (!warrantImpossible && filledText)) && familiarSelected;
...
function updateSanityCheckBox(reasonId) {
    ...
    var rephrasedText = $("#" + reasonId + "_opposingStance_warrant");
...
$(document).ready(function () {
    ...
    $("input:checkbox").change(function () {
        ...
        var textboxWarrant = $("#" + reasonId + "_opposingStance_warrant");
