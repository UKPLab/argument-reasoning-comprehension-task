 ...
 */
public class ArgumentWordCountFilter
        implements ArgumentSamplingFilter
{
    final int lowerBoundaries = 40;
    final int upperBoundaries = 200;
            ...
            throws IOException
    {
        ...
        return (wordCount >= lowerBoundaries && wordCount <= upperBoundaries);
    }
}
