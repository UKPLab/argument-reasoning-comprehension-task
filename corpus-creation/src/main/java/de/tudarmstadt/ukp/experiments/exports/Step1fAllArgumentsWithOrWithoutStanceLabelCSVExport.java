 ...
 */
public class Step1fAllArgumentsWithOrWithoutStanceLabelCSVExport
{
            ...
            throws IOException
    {
        ...
        List<StandaloneArgument> argumentList = arguments.stream()
                .filter(a -> a.getAnnotatedStanceAsInt() == 0 || a.getAnnotatedStanceAsInt() == 1 || a.getAnnotatedStanceAsInt() == 2)
                .collect(Collectors.toList());

        // consistency check
        if (4448 != argumentList.size()) {
        ...
        for (StandaloneArgument a : argumentList) {
            ...
            csvPrinter.printRecord(
                    ...
                    a.getAnnotatedStance() != null ? a.getAnnotatedStance() : "no_stance"
            );
        }
            ...
            throws IOException
    {
        export(new File("mturk/annotation-task/data/22-stance-batch-0001-5000-all.xml.gz"),
                new File("mturk/annotation-task/data/exported-4448-comments-incl-no-stance.tsv"));
