 ...
 */
public class PointsReceivedFilter
        implements ArgumentSamplingFilter
{
    private final int mininumPoints;

    public PointsReceivedFilter(int minPoints)
    {
        this.mininumPoints = minPoints;
    }
    ...
    public boolean keepArgument(Argument argument, Debate parentDebate)
            throws IOException
    {
        return argument.getVoteUpCount() >= mininumPoints;
    }
}
