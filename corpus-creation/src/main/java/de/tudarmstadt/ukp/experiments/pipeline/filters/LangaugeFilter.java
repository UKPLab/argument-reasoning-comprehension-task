 ...
 */
public class LangaugeFilter implements ArgumentSamplingFilter
{
    final private LanguageIdentifier li = new CybozuLanguageIdentifier();

    @Override
    public boolean keepArgument(Argument argument, Debate parentDebate)
            throws IOException
    {
        // only truly English ones
        String language = li.identifyLanguage(argument.getOriginalHTML());
